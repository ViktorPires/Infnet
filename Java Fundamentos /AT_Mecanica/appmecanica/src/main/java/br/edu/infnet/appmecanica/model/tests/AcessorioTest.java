...
public class AcessorioTest {
	...
	public static void main(String[] args) {
		...
		try {
			Acessorio acessorio3 = new Acessorio("Porta Bicicletas", 500, "Lazer", "Transbikes", false, false);
		...
		try {
			Acessorio acessorio4 = new Acessorio("Bagageiro", 500, "Lazer", "Transbags", false, false);
